...
> 💡 **Примечание:** Все AI-компоненты, включая Memory LLM Service, AI Agents и ML-модели, были вынесены в отдельный репозиторий для лучшей модульности.
>
> **Новый репозиторий AI-сервисов:** [Kabalod/MemoryProjectDubai](https://github.com/Kabalod/MemoryProjectDubai)
