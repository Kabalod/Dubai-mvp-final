...
export default function PricingPage() {
  const plans = [
    {
      ...
      features: ["Up to 100 property views per month", "Basic market analytics", "Standard support", "Export to PDF"],
      limitations: ["Advanced analytics", "API access", "Custom reports", "Priority support"],
      popular: false,
      current: false,
    },
    {
  ...
  const addOns = [
    ...
    { name: "Custom Analytics", price: "199", unit: "per month", description: "Tailored analytics dashboard" },
  ]
          ...
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">We offer a 30-day money-back guarantee for all paid plans.</p>
              </div>
            </div>
          </CardContent>
        </Card>
