...
try {
    $frontendResponse = Invoke-WebRequest -Uri "https://frontend-production-261c.up.railway.app/" -Method GET -TimeoutSec 10
...
Write-Host "1. Откройте: https://frontend-production-261c.up.railway.app/auth" -ForegroundColor Yellow
